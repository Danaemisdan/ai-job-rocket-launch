            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-x-0 top-[56px] bottom-0 z-50 md:hidden bg-background border-t border-border/40 p-4 flex flex-col items-center justify-start gap-8 pt-12"
                    >
