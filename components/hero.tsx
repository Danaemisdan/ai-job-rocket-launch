    ...
    return (
        <section className="relative flex flex-col items-center justify-center space-y-10 py-24 md:py-32 lg:py-40 overflow-hidden">
            ...
            <div className="container flex max-w-[64rem] flex-col items-center text-center gap-4 px-4">
                <div className="inline-flex items-center rounded-full border border-border bg-background px-3 py-1 text-sm text-muted-foreground backdrop-blur-xl">
                    <span className="flex h-2 w-2 rounded-full bg-primary mr-2 animate-pulse"></span>
                    <span className="text-xs font-medium">New AI Model V2.0 Released</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
                    ...
                    <AnimatedButton href="#demo" variant="secondary" className="w-full sm:w-auto h-12 px-8 min-w-[160px]">
